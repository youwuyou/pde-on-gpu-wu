...
@views function implicit_porous_convection_2D(Ra::Float64)
    # physics
    lx, ly        = 40.0, 20.0
    k_ηf          = 1.0
...
implicit_porous_convection_2D(10.)
# implicit_porous_convection_2D(40.)
# implicit_porous_convection_2D(100.)
# implicit_porous_convection_2D(1000.)